...
import com.guoxiaoxing.cloud.music.magicasakura.widgets.TintProgressBar;
...
public class QuickControlsFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPlayPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MusicPlayer.getQueueSize() == 0) {
                    Toast.makeText(CloudMusicApp.mContext, getResources().getString(R.string.queue_is_empty),
                            Toast.LENGTH_SHORT).show();
                } else {
                    HandlerUtil.getInstance(CloudMusicApp.mContext).postDelayed(new Runnable() {
                        @Override
                        public void run() {
        ...
        rootView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CloudMusicApp.mContext, PlayingActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                CloudMusicApp.mContext.startActivity(intent);
            }
        });
    ...
    public void updateNowplayingCard() {
        ...
        Uri uri = null;
        try {
            if (!TextUtils.isEmpty(MusicPlayer.getAlbumPath())) {
