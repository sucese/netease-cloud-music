...
import com.guoxiaoxing.cloud.music.adapter.MusicFlowAdapter;
import com.guoxiaoxing.cloud.music.adapter.OverFlowAdapter;
import com.guoxiaoxing.cloud.music.adapter.OverFlowItem;
import com.guoxiaoxing.cloud.music.service.download.Down;
import com.guoxiaoxing.cloud.music.handler.HandlerUtil;
import com.guoxiaoxing.cloud.music.model.SearchAlbumInfo;
import com.guoxiaoxing.cloud.music.model.SearchArtistInfo;
...
import com.guoxiaoxing.cloud.music.ui.activity.ArtistDetailActivity;
import com.guoxiaoxing.cloud.music.service.MusicPlayer;
import com.guoxiaoxing.cloud.music.widget.DividerItemDecoration;
import com.guoxiaoxing.cloud.music.widget.dialog.AddNetPlaylistDialog;
                        ...
                        new AlertDialog.Builder(mContext).setTitle("要下载音乐吗").
                                setPositiveButton(mContext.getString(R.string.sure), new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        Down.downMusic(CloudMusicApp.mContext, adapterMusicInfo.songId + "", adapterMusicInfo.musicName, adapterMusicInfo.artist);
                                        dialog.dismiss();
                                    }
                                }).
                                ...
                                protected Void doInBackground(Void... params) {
                                    ...
                                    try {
                                        ...
                                        for (JsonElement o : artistArray) {
                                            SearchArtistInfo artistInfo = CloudMusicApp.gsonInstance().fromJson(o, SearchArtistInfo.class);
...
//                                        }
                                        ...
                                        for (JsonElement o : albumArray) {
                                            SearchAlbumInfo albumInfo = CloudMusicApp.gsonInstance().fromJson(o, SearchAlbumInfo.class);
