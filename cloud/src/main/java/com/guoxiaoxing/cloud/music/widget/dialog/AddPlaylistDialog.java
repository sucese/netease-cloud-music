package com.guoxiaoxing.cloud.music.widget.dialog;
...
import com.guoxiaoxing.cloud.music.ui.fragment.AttachDialogFragment;
import com.guoxiaoxing.cloud.music.service.MusicTrack;
                    ...
                    public void onClick(View v) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                for (long id : musicId) {
                                    albumart = MusicUtils.getAlbumdata(CloudMusicApp.mContext, id);
                                    if (albumart != null) {
                                        break;
                                    }
                                }
                                ...
                                for (int i = 0; i < musicId.length; i++) {
                                    playlistsManager.insert(CloudMusicApp.mContext, editText.getText().hashCode(), musicId[i], i);
                                }
