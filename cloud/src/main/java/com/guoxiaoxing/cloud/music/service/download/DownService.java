package com.guoxiaoxing.cloud.music.service.download;
...
import com.guoxiaoxing.cloud.music.ui.activity.DownActivity;
...
public class DownService extends Service {
    public static final String ADD_DOWNTASK = "com.guoxiaoxing.cloud.music.downtaskadd";
    public static final String ADD_MULTI_DOWNTASK = "com.guoxiaoxing.cloud.music.multidowntaskadd";
    public static final String CANCLE_DOWNTASK = "com.guoxiaoxing.cloud.music.cacletask";
    public static final String CANCLE_ALL_DOWNTASK = "com.guoxiaoxing.cloud.music.caclealltask";
    public static final String START_ALL_DOWNTASK = "com.guoxiaoxing.cloud.music.startalltask";
    public static final String RESUME_START_DOWNTASK = "com.guoxiaoxing.cloud.music.resumestarttask";
    public static final String PAUSE_TASK = "com.guoxiaoxing.cloud.music.pausetask";
    public static final String PAUSE_ALLTASK = "com.guoxiaoxing.cloud.music.pausealltask";

    public static final String UPDATE_DOWNSTAUS = "com.guoxiaoxing.cloud.music.updatedown";
    public static final String TASK_STARTDOWN = "com.guoxiaoxing.cloud.music.taskstart";
    public static final String TASKS_CHANGED = "com.guoxiaoxing.cloud.music.taskchanges";
    ...
    private Notification getNotification(boolean complete) {
        ...
        nowPlayingIntent.setComponent(new ComponentName("com.guoxiaoxing.cloud.music", "DownActivity"));
