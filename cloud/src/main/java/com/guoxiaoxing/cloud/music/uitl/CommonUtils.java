...
public class CommonUtils {
    ...
    public static String getDeviceInfo() {
        ...
        builder.append("APP.VERSION = " + getAPPVersionCode(CloudMusicApp.mContext) + "\n");
        builder.append("\n" + "log:" + "\n");
...
//    public static final String makeShortTimeString(final Context mContext, long secs) {
//        long hours, mins;
//
//        hours = secs / 3600;
//        secs %= 3600;
...
//        secs %= 60;
//
//        final String durationFormat = mContext.getResources().getString(
