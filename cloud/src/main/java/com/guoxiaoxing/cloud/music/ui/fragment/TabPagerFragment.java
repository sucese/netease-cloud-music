...
import com.guoxiaoxing.cloud.music.ui.activity.LocalSearchActivity;
...
public class TabPagerFragment extends AttachDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) rootView.findViewById(R.id.activity_main_toolbar);
        ...
        ImageView search = (ImageView) rootView.findViewById(R.id.activity_main_bar_search);
