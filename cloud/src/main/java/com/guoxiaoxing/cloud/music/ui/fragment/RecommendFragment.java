...
import com.guoxiaoxing.cloud.music.model.RecommendListNewAlbumInfo;
import com.guoxiaoxing.cloud.music.model.RecommendListRadioInfo;
import com.guoxiaoxing.cloud.music.model.RecommendListRecommendInfo;
import com.guoxiaoxing.cloud.music.api.HttpUtil;
import com.guoxiaoxing.cloud.music.api.NetworkUtils;
import com.guoxiaoxing.cloud.music.ui.activity.AlbumsDetailActivity;
import com.guoxiaoxing.cloud.music.ui.activity.NetItemChangeActivity;
import com.guoxiaoxing.cloud.music.ui.activity.PlaylistActivity;
import com.guoxiaoxing.cloud.music.ui.activity.RadioDetailActivity;
import com.guoxiaoxing.cloud.music.uitl.PreferencesUtility;
import com.guoxiaoxing.cloud.music.widget.LoodView;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    ...
                    for (int i = 0; i < 6; i++) {
                        mRecomendList.add(CloudMusicApp.gsonInstance().fromJson(recommendArray.get(i), RecommendListRecommendInfo.class));
                        mNewAlbumsList.add(CloudMusicApp.gsonInstance().fromJson(newAlbumArray.get(i), RecommendListNewAlbumInfo.class));
                        mRadioList.add(CloudMusicApp.gsonInstance().fromJson(radioArray.get(i), RecommendListRadioInfo.class));
                    }
