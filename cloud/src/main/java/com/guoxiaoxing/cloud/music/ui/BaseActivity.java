package com.guoxiaoxing.cloud.music.ui;
...
import com.guoxiaoxing.cloud.music.ui.activity.MusicStateListener;
import com.guoxiaoxing.cloud.music.ui.fragment.QuickControlsFragment;
...
import static com.guoxiaoxing.cloud.music.service.MusicPlayer.mService;
    ...
    protected void showQuickControl(boolean show) {
        ...
        if (show) {
            if (fragment == null) {
                ...
                ft.add(R.id.activity_main_bottom_container, fragment).commitAllowingStateLoss();
            } else {
