...
public class MusicLibraryFragment extends AttachFragment implements ChangeView {
    ...
    public static final MusicLibraryFragment newInstance(int page, String[] title) {
        MusicLibraryFragment f = new MusicLibraryFragment();
