...
import com.guoxiaoxing.cloud.music.model.BillboardJson;
        ...
        protected Boolean doInBackground(final Void... unused) {
            try {
                ...
                for (int i = 0; i < musicCount; i++) {
                    BillboardJson billboardJson = CloudMusicApp.gsonInstance().fromJson(pArray.get(i), BillboardJson.class);
